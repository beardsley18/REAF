...
/// <summary>
/// Class representing the VPE Gryo Basic Tuning register.
/// </summary>
public class VpeGryoBasicTuningRegister
{
	/// <summary>
	/// The AngularWalkVariance field.
	/// </summary>
	...
	/// <summary>
	/// Creates a new VpeGryoBasicTuningRegister with default initialization values.
	/// </summary>
	public VpeGryoBasicTuningRegister() { }

	/// <summary>
	/// Creates a new VpeGryoBasicTuningRegister with the provided values.
	/// </summary>
	/// <param name="angularWalkVariance">
	/// Value to initialize the AngularWalkVariance field with.
	/// </param>
	...
	/// Value to initialize the AdaptiveTuning field with.
	/// </param>
	public VpeGryoBasicTuningRegister(vec3f angularWalkVariance, vec3f baseTuning, vec3f adaptiveTuning)
	{
		AngularWalkVariance = angularWalkVariance;
		BaseTuning = baseTuning;
		AdaptiveTuning = adaptiveTuning;
