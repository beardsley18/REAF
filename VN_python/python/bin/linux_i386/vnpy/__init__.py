...
if platform.architecture()[0] != '32bit' or os.name != 'posix':
    raise Exception('detected {0}|{1} environment whereas this library supports only 32bit|posix'.format(platform.architecture()[0], os.name))
