...
int main()
{
	...
	char mockBinaryAsyncData[] = { 0xFA, 0x01, 0x09, 0x00, 0x70, 0x05, 0x00, 0x03, 0x0A, 0x00, 0x00, 0x00, 0x48, 0x0E, 0x2C, 0x42, 0x08, 0x4C, 0x37, 0xC1, 0x10, 0x38, 0x8B, 0xC2, 0xD4, 0xCB };
	...
	VnUartPacketFinder_processReceivedData(&up, buffer, numOfBytes);
	...
	/* Mock that the sensor responded to our request. */
	UserUart_mockReceivedData(mockBinaryAsyncData, 26);
