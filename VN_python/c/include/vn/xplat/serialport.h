...
*
* \section DESCRIPTION
* This header file contains structures and functions for accessing a serial port.
*/
#ifndef _VN_SERIALPORT_H_
#define _VN_SERIALPORT_H_
