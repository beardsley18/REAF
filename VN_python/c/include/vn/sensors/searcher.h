...
/** \brief Struct containing information about the port to be searched. */
typedef struct VnPortInfo
{
...
/** \brief Takes a VnPortInfo struct and returns the name of the port.
 * \parm[in] portInfo Pointer to a VnPortInfo struct
 * \return The name of the port
 */
char* VnSearcher_getPortName(VnPortInfo* portInfo);

/** \brief Takes a VnPortInfo struct and returns the baud rate or error code.
 * \parm[in] portInfo Pointer to a VnPortInfo struct
