...
VnError VnSpi_parseVpeGryoBasicTuning(
	const char* response,
	...
	vec3f accRef)
{
	...
	*pos++ = 0;
	*pos++ = 0;
	magRef.x = htosf4(magRef.x);
	magRef.y = htosf4(magRef.y);
	magRef.z = htosf4(magRef.z);
	memcpy(pos, &magRef, sizeof(vec3f));
	pos += sizeof(vec3f);
	accRef.x = htosf4(accRef.x);
	accRef.y = htosf4(accRef.y);
	accRef.z = htosf4(accRef.z);
	...
	vec3f adaptiveFiltering)
{
	...
	*pos++ = 0;
	*pos++ = 0;
	baseTuning.x = htosf4(baseTuning.x);
	baseTuning.y = htosf4(baseTuning.y);
	baseTuning.z = htosf4(baseTuning.z);
	memcpy(pos, &baseTuning, sizeof(vec3f));
	pos += sizeof(vec3f);
	adaptiveTuning.x = htosf4(adaptiveTuning.x);
	adaptiveTuning.y = htosf4(adaptiveTuning.y);
	adaptiveTuning.z = htosf4(adaptiveTuning.z);
	memcpy(pos, &adaptiveTuning, sizeof(vec3f));
	pos += sizeof(vec3f);
	adaptiveFiltering.x = htosf4(adaptiveFiltering.x);
	adaptiveFiltering.y = htosf4(adaptiveFiltering.y);
	adaptiveFiltering.z = htosf4(adaptiveFiltering.z);
	...
	vec3f velocity)
{
	...
	*pos++ = 0;
	*pos++ = 0;
	velocity.x = htosf4(velocity.x);
	velocity.y = htosf4(velocity.y);
	velocity.z = htosf4(velocity.z);
	...
	vec3f position)
{
	...
	*pos++ = 0;
	*pos++ = 0;
	position.x = htosf4(position.x);
	position.y = htosf4(position.y);
	position.z = htosf4(position.z);
	...
	float pressureBias)
{
	...
	*pos++ = 0;
	*pos++ = 0;
	gyroBias.x = htosf4(gyroBias.x);
	gyroBias.y = htosf4(gyroBias.y);
	gyroBias.z = htosf4(gyroBias.z);
	memcpy(pos, &gyroBias, sizeof(vec3f));
	pos += sizeof(vec3f);
	accelBias.x = htosf4(accelBias.x);
	accelBias.y = htosf4(accelBias.y);
	accelBias.z = htosf4(accelBias.z);
	...
	vec3d position)
{
	...
	*pos++ = resv2;
	...
	pos += sizeof(float);
	pos += 4;
	position.x = htosf8(position.x);
	position.y = htosf8(position.y);
	position.z = htosf8(position.z);
	...
	vec3f uncertainty)
{
	...
	*pos++ = 0;
	...
	memcpy(pos, &position, sizeof(vec3f));
	pos += sizeof(vec3f);
	uncertainty.x = htosf4(uncertainty.x);
	uncertainty.y = htosf4(uncertainty.y);
	uncertainty.z = htosf4(uncertainty.z);
